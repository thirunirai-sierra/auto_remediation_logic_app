...
// ----------------------------------------------------------------------
// NEW OBSERVABILITY ENDPOINTS (with safe parameter handling)
// ----------------------------------------------------------------------
export async function fetchMonitorMessages(limit: any = 50, offset: any = 0): Promise<{ messages: unknown[]; total: number }> {
  // Ensure limit and offset are numbers (prevent [object Object] bug)
...
// ----------------------------------------------------------------------
// Autonomous / Pipeline endpoints (updated to new API)
// ----------------------------------------------------------------------
...
// ----------------------------------------------------------------------
// Legacy paginated endpoints (unchanged)
// ----------------------------------------------------------------------
