...
import type { InternalProps as ObjectPageTitlePropTypesWithInternals, ObjectPageTitlePropTypes } from '../../ObjectPageTitle/types/index.js';
...
export type HandleOnSectionSelectedType = (targetEvent: Event | Record<string, never>, newSelectionSectionId: string, index: number | string, section: HTMLElement) => void;
export {};
