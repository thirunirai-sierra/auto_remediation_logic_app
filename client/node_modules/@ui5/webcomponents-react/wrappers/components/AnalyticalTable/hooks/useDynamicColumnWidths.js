...
const useColumnsDeps = (deps, {
  ...
  return [...deps, hasRows, colsEqual, visibleColumns?.length, !state.tableColResized && state.tableClientWidth, state.hiddenColumns.length, webComponentsReactProperties.scaleWidthMode, isLoadingPlaceholder, webComponentsReactProperties.fontsReady];
};
const columns = (columns, {
  ...
  if (!instance.state || !instance.rows || columns.length === 0 || !totalWidth || !AnalyticalTableScaleWidthMode[scaleWidthMode] || !fontsReady) {
    return columns;
  }
