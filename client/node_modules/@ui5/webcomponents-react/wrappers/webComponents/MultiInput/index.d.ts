...
interface MultiInputPropTypes extends MultiInputAttributes, Omit<CommonProps, keyof MultiInputAttributes | 'children' | 'icon' | 'tokens' | 'valueStateMessage' | 'onChange' | 'onClose' | 'onInput' | 'onOpen' | 'onSelect' | 'onSelectionChange' | 'onTokenDelete' | 'onValueHelpTrigger'> {
    /**
 ...
 */
declare const MultiInput: import("react").ForwardRefExoticComponent<MultiInputPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<MultiInputDomRef>>;
export { MultiInput };
