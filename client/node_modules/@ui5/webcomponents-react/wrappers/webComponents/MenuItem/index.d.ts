...
interface MenuItemPropTypes extends MenuItemAttributes, Omit<CommonProps, keyof MenuItemAttributes | 'children' | 'deleteButton' | 'endContent' | 'onBeforeClose' | 'onBeforeOpen' | 'onCheck' | 'onClose' | 'onDetailClick' | 'onOpen'> {
    /**
 ...
 */
declare const MenuItem: import("react").ForwardRefExoticComponent<MenuItemPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<MenuItemDomRef>>;
export { MenuItem };
