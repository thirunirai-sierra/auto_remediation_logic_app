...
interface FileUploaderPropTypes extends FileUploaderAttributes, Omit<CommonProps, keyof FileUploaderAttributes | 'children' | 'valueStateMessage' | 'onChange' | 'onFileSizeExceed'> {
    /**
 ...
 */
declare const FileUploader: import("react").ForwardRefExoticComponent<FileUploaderPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<FileUploaderDomRef>>;
export { FileUploader };
