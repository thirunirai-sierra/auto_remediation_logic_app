...
import type { NotificationItemClickEventDetail, NotificationItemCloseEventDetail, NotificationItemToggleEventDetail } from '@ui5/webcomponents-fiori/dist/NotificationList.js';
...
interface NotificationListPropTypes extends NotificationListAttributes, Omit<CommonProps, keyof NotificationListAttributes | 'children' | 'onItemClick' | 'onItemClose' | 'onItemToggle'> {
    /**
 ...
 */
declare const NotificationList: import("react").ForwardRefExoticComponent<NotificationListPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<NotificationListDomRef>>;
