...
interface WizardPropTypes extends WizardAttributes, Omit<CommonProps, keyof WizardAttributes | 'children' | 'onStepChange'> {
    /**
     * Defines the steps.
     *
 ...
 */
declare const Wizard: import("react").ForwardRefExoticComponent<WizardPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<WizardDomRef>>;
export { Wizard };
