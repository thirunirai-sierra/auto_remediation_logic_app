...
interface TreeItemPropTypes extends TreeItemAttributes, Omit<CommonProps, keyof TreeItemAttributes | 'children' | 'deleteButton' | 'image' | 'onDetailClick'> {
    /**
 ...
 */
declare const TreeItem: import("react").ForwardRefExoticComponent<TreeItemPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<TreeItemDomRef>>;
export { TreeItem };
