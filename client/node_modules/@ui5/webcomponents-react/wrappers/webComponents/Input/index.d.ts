...
interface InputPropTypes extends InputAttributes, Omit<CommonProps, keyof InputAttributes | 'children' | 'icon' | 'valueStateMessage' | 'onChange' | 'onClose' | 'onInput' | 'onOpen' | 'onSelect' | 'onSelectionChange'> {
    /**
 ...
 */
declare const Input: import("react").ForwardRefExoticComponent<InputPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<InputDomRef>>;
export { Input };
