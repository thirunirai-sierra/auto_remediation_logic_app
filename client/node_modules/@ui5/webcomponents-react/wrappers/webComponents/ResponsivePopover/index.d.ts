...
interface ResponsivePopoverPropTypes extends ResponsivePopoverAttributes, Omit<CommonProps, keyof ResponsivePopoverAttributes | 'children' | 'footer' | 'header' | 'onBeforeClose' | 'onBeforeOpen' | 'onClose' | 'onOpen'> {
    /**
 ...
 */
declare const ResponsivePopover: import("react").ForwardRefExoticComponent<ResponsivePopoverPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<ResponsivePopoverDomRef>>;
