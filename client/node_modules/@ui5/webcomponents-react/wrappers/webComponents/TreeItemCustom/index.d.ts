...
interface TreeItemCustomPropTypes extends TreeItemCustomAttributes, Omit<CommonProps, keyof TreeItemCustomAttributes | 'children' | 'content' | 'deleteButton' | 'image' | 'onDetailClick'> {
    /**
 ...
 */
declare const TreeItemCustom: import("react").ForwardRefExoticComponent<TreeItemCustomPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<TreeItemCustomDomRef>>;
