...
interface SearchPropTypes extends SearchAttributes, Omit<CommonProps, keyof SearchAttributes | 'action' | 'children' | 'filterButton' | 'illustration' | 'messageArea' | 'scopes' | 'onClose' | 'onInput' | 'onOpen' | 'onScopeChange' | 'onSearch'> {
    /**
 ...
 * @experimental
 */
declare const Search: import("react").ForwardRefExoticComponent<SearchPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<SearchDomRef>>;
export { Search };
