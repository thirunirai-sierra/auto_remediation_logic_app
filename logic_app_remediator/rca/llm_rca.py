...
from logic_app_remediator.rca.models.rca_model import Action, JSONDict, LLMClient, RCAResult
...
def generate_rca_with_llm(
    *,
    ...
    out = llm_client.complete_json(system_prompt=system, user_prompt=user)
